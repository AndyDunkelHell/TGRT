...
// Define IntArrayUniquePtr as a type alias for std::unique_ptr<TfLiteIntArray>
using IntArrayUniquePtr = std::unique_ptr<TfLiteIntArray, decltype(&TfLiteIntArrayFree)>;
...
TfLiteStatus GetOutputShapeFromInput(TfLiteContext* context,
  ...
  IntArrayUniquePtr shape(TfLiteIntArrayCreate(output_dims), TfLiteIntArrayFree);
...
TfLiteStatus CalculateShapeForBroadcast(TfLiteContext* context,
  ...
  IntArrayUniquePtr shape(TfLiteIntArrayCreate(out_dims), TfLiteIntArrayFree);
